...
onready var water_spring = preload("res://src/Utils/Water/Scenes/Water_Spring.tscn")
...
onready var splash_particle = preload("res://src/Utils/Water/Scenes/splash_particles.tscn")
